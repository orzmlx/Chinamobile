...
def parse():
    try:
        ...
        df_5g.to_csv(os.path.join(os.path.abspath(out_put_path), "物理站CGI_5g.csv"), encoding='utf-8-sig', index=False)
...
if __name__ == "__main__":
    ...
    common_cols = ['地市', '区县', '区域', '物理站编号', '物理站名', '基站类型', '分布系统编号', '室内外', '覆盖场景', '经度', '纬度', '全部制式', '4G频段',
