...
class HuaweiRawDataFile(Reader):
    ...
    def __read_one_unit_message(self, f, line):
        ...
        self.exist_value.append(self.current_network_element)
        ...
        while line:
            ...
            if line.find(huawei_configuration.END) >= 0:
                self.exist_value.append(latest_value)
    ...
    def make_up_content(self, new_cols, new_row):
    ...
    def makeup_and_update_content(self, new_cols, new_row):
        command_dict = self.command_content_dict[self.current_command]
